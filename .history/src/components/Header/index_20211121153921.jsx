        ...
        <div className="nav">
            ...
            <nav className="nav-pc">
                <ul className="nav__list">
                    <li>
                        <NavLink exact to="/" className="nav__link">TRANG CHỦ</NavLink>
                    </li>
                    <li className="options">
                        <NavLink to="/Sanpham" className="nav__link">SẢN PHẨM<i className="fas fa-chevron-down"></i></NavLink>
                    ...
                    <li>
                        <NavLink to="/Giothieu" className="nav__link">GIỚI THIỆU</NavLink>
                    </li>
                    <li>
                        <NavLink to="/Tintuc" className="nav__link">TIN TỨC</NavLink>
                    </li>
                    <li>
                        <NavLink to="/Lienhe" className="nav__link">LIÊN HỆ</NavLink>
                    </li>
                </ul>
            </nav>
