          ...
          <div className="user-hover">
            <ul className="user-hover-list">
              ...
              <li className="nav_link">
                {user ? <Link to="/Admin">Profile</Link> : <Link to="/Register">Đăng Ký</Link> }
                
              </li>
              <li className="nav_link">
                {user ? <Link to={} onClick={() => firebase.auth().signOut()}> Đăng xuất</Link> : <Link to="/"> Đăng nhập</Link> }
              </li>
            </ul>
          </div>
        </div>
