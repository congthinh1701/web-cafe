        ...
        <div className="nav">
            ...
            <nav className="nav-pc">
                <ul className="nav__list">
                    <li>
                        <a href="home.html" className="nav__link">TRANG CHỦ</a>
                    </li>
                    <li className="options">
                        <a href="#/" className="nav__link">SẢN PHẨM<i className="fas fa-chevron-down"></i></a>
                            ...
                            <div className="container">
                                ...
                                <div className="row">
                                    <div className="col-xl-6 col-sm-6 col-md-6 modal-img">
                                        <img src={require('../../assets/img/modal1.jpg')} alt="Search"/>
                                    </div>
                                    <div className="col-xl-6 col-sm-6 col-md-6  modal-img">
                    ...
                    <li>
                        <a href="tintuc.html" className="nav__link">TIN TỨC</a>
                    </li>
                    <li>
                        <a href="lienhe.html" className="nav__link">LIÊN HỆ</a>
                    </li>
                </ul>
            </nav>
