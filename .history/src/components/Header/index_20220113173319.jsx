    ...
    return (
        <div className="nav">
            ...
            <div className="nav-right">
                ...
                <div className="user">
                    <a href="#/"> {user ? user.name : <i className="fas fa-user"></i> } </a>
                    {user ? <img src="https://lh3.googleusercontent.com/a/AATXAJyWkdjElc5BniNHsd_Fn_ITXHKUBvZkBAPx2az8=s96-c" alt='name'/> : }
