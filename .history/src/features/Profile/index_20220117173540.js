...
function Profile() {
  ...
  const [nameProfi,setName]=useState()
              ...
              <Modal show={show}>
                ...
                <Modal.Body style={{ marginTop: "5px" }}>
                  <div className="form-group">
                    <label>Name :</label>
                    <input ref={nameRef} className="form-control" type="name" onChange={(e)=>{setName(e.target.value)}} />
                  </div>
                  <div className="form-group">
                    <label>Phone :</label>
                    <input
                      ...
                      type="number" onChange={(e)=>{setIPhone(e.target.value)}}
                    />
                  </div>
                  <div className="form-group">
                    <label>Avatar :</label>
