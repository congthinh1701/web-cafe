...
function Profile() {
  ...
  const avatarStgRef = firebase.storage().ref("Usuarios/" + user.uid + "/avatar.jpg");
            ...
            <div className="profileInformation">
              ...
              <Modal show={show}>
                ...
                <Modal.Body style={{ marginTop: "5px" }}>
                  ...
                  <div className="form-group">
                    <label>Avatar :</label>
                    <input className="form-control" type="file" ref={fileRef} onChange={(e)=>{setImage(e.target.files[0])}} />
                  </div>
                </Modal.Body>
                <Modal.Footer>
