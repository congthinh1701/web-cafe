...
function Profile() {
  ...
  const fileRef = useRef(); // value i avatar user
  const nameRef=useRef()    // value name user
  const phoneRef=useRef()   // value phone user
            ...
            <div className="profileInformation">
              ...
              <Modal show={show}>
                ...
                <Modal.Body style={{ marginTop: "5px" }}>
                  ...
                  <div className="form-group">
                    <label>Phone :</label>
                    <input ref={phoneRef} className="form-control" type="number"  />
                  </div>
                  <div className="form-group">
                    <label>Avatar :</label>
