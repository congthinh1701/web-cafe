...
import { dataForm } from "../../../actions/form";

function FormAddress({ formValue }) {
  ...
  const submit = (values) => {
    ...
    console.log(selectedCity, selectedDistrict, stateValidate);
  };

  // transnit data go up parents component Bill
  formValue(valueForm);

  const action = dataForm(stateValidate, valueForm);
  dispatch(action)
