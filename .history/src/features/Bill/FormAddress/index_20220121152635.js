...
function FormAddress(props) {
  ...
  const { stateValidate, handleChangeEmail , handleBlurEmail ,handleChangeName ,handleBlurName ,handleBlurPhone ,handleChangePhone}=ValidateForm()
