...
function Section2() {
    ...
    return (
        <div>
            <div  className={clsx(styles.section2)} style={{ backgroundImage: `url(${banner_section2})`, backgroundSize: 'cover', backgroundPosition: 'center center', backgroundRepeat: 'no-repeat' }}>
                                ...
                                <div key={data.id} className='col-xl-6 col-lg-6 col-md-12'>
                                    <div className={clsx(styles.Product)}>
                                        <div className={clsx(styles.ProductImg)}>
                                            <img src='https://dbk.vn/uploads/ckfinder/images/tranh-anh/Anh-thien-nhien-1.jpg'/>
                                        </div>
