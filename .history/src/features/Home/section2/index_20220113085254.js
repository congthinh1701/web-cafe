...
function Section2() {
  ...
  // dispatch data  go up redux detailReducer
  ...
  return (
    <div>
      <div
        className={clsx(styles.section2)}
        style={{
          backgroundImage: `url(${banner_section2})`,
        ...
        <div className="container">
          <div className={clsx(styles.section2Content)}>
                ...
                <div key={data.id} className="col-xl-6 col-lg-6 col-md-12">
                  <div className={clsx(styles.Product)}>
                    ...
                    <div className={clsx(styles.ProductTitle)}>
                      <Link
                        className={clsx(styles.ProductTitleName)}
                        to="/Sanpham/Detail"
                        onClick={() => dataDetail(data)}
                      >
                        {data.Name}
                      </Link>
            ...
            <div className={clsx(styles.Menu)}>
              <Link to="/Sanpham">Xem thêm menu</Link>
            </div>
