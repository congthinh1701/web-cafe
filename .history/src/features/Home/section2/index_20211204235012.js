                                ...
                                <div key={data.id} className='col-xl-6 col-lg-6 col-md-12'>
                                    <div className={clsx(styles.Product)}>
                                        <div className={clsx(styles.ProductImg)}>
                                            <img src={'https://firebasestorage.googleapis.com/v0/b/web-cafe-806eb.appspot.com/o/NoiBat%2Fproduct6.png?alt=media&token=d0c311b8-d574-49ab-bd1b-62870603ca01'} alt={data.Name}/>
                                        </div>
