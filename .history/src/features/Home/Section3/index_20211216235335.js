...
function Section3(){
    ...
    useEffect(() => {
        firebaseConnect.database().ref('Product/Coffee').on('value', snapshot => {
            let list = []
            ...
            {coffee.map(data =>(
                <div key={data.id} className={clsx(styles.item)}>
                    <a href='/'>
                        ...
                        <img src="https://dbk.vn/uploads/ckfinder/images/tranh-anh/Anh-thien-nhien-1.jpg" alt={data.Name} />
