         ...
         <div className="container">
            <div className="row">
               ...
               <div className="col-xl-5 col-lg-5 col-md-5 col-12">
                  <div className="row">
                     <div className="col-md-6 mt-4" id={clsx(styles.home_banner2)} style={{ backgroundImage: `url(${home_banner2})` }}>
                        <div className={clsx(styles.content)}>
                           <p className={clsx(styles.title)}>Ưu đãi bất ngờ</p>
                           <button>Tìm hiểu</button>
                        </div>
                     </div>
                     <div className="col-md-6 mt-4" id={clsx(styles.home_banner3)} style={{ backgroundImage: `url(${home_banner3})` }}>
                        <div className={clsx(styles.content)}>
