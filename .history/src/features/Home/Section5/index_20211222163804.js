  ...
  return (
    <div>
      ...
      <div className="container content">
        <div className="content1 tab-content">
            <div className={clsx(styles.content1-img)}>
        ...
        <div className="content2 tab-content active">
            <div className="content2-img">
                <img src="assets/img/tintuc/2.jpg" alt="anh"/>                    
            </div>
        ...
        <div className="content3 tab-content">
            <div className="content3-img">
                <img src="assets/img/tintuc/3.jpg" alt="anh"/>                    
            </div>
