                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <a href=""><img src="img/banerlon1.png" class="d-block w-100" alt="..."></a>
                            </div>
                            <div class="carousel-item">
                                <a href=""><img src="img/banerlon2.png" class="d-block w-100" alt="..."/></a>
                            </div>
                            <div class="carousel-item">
                                <a href=""><img src="img/banerlon3.png" class="d-block w-100" alt="..."/></a>
                            </div>
                            <div class="carousel-item">
                                <a href=""><img src="img/pexels-christian-heitz-842711.jpg" class="d-block w-100"
                                        alt="..."/></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="banner-con col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
                    <div class="row">
                        <div class="baner-con-item col-12">
                            <a href=""><img src="img/baner1.png" alt=""/></a>
                        </div>
                        <div class="baner-con-item col-12">
                            <a href=""><img src="img/baner2.png" alt=""/></a>
                        </div>
                        <div class="baner-con-item col-12">
                            <a href=""><img src="img/pexels-christian-heitz-842711.jpg" alt=""/></a>
                        </div>
                    </div>
                </div>
            </div>
