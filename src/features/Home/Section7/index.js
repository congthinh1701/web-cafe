        ...
        <div className="row text-center">
          ...
          <div className={clsx(styles.Section7)}>
              <div className={clsx(styles.Img)}>
                <img
                  src={
                    "https://bizweb.dktcdn.net/100/351/580/themes/714586/assets/image-feature2.png?1628672823934"
                  }
                  alt="anh"
                />
              </div>
          ...
          <div className={clsx(styles.Section7)}>
              <div className={clsx(styles.Img)}>
                <img
                  src={
                    "https://bizweb.dktcdn.net/100/351/580/themes/714586/assets/image-feature3.png?1628672823934"
                  }
                  alt="anh"
                />
              </div>
              <div className={clsx(styles.Header)}>
                <p>DESSERT ĐẶC BIỆT</p>
              </div>
              <div className={clsx(styles.Content)}>
                <p>
